...
pihole-regex/uninstall.py /
@mmotti
mmotti Minor code tweaks
Latest commit f0dded8 on 19 Mar
 History
 1 contributor
160 lines (124 sloc)  5.25 KB
...
url_regexps_remote = 'https://raw.githubusercontent.com/anthony-wang/PiHoleBlocklist/master/regex.list'
...
install_comment = 'github.com/adsblockmax/AdsBlockPhim'
